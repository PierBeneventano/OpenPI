...
The full historical research engine is preserved for V1. The redesign should
not weaken the current ability to produce paper-like research artifacts. The
work is to make the engine inspectable, steerable, auditable, and product-grade:
