...
class CampaignClient:
    ...
    def workspace(self, ref: str | Path, *, include_diagnostic_events: bool = False) -> dict[str, Any]:
        return self.store.workspace_read_model(ref, include_diagnostic_events=include_diagnostic_events)
